...
function container2() {
  return (
    <section id="container2" className="shadow-lg flex items-center justify-start h-auto pt-5 pb-20 bg-slate-400 p-8 flex-col sm:flex-row overflow-x-hidden">

                <div className="w-full sm:w-1/2 pl-8 mt-20">
